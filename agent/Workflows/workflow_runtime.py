...
from agent.Agents.models import AgentLoopCommand
from agent.Common.Exceptions.agent_exception import AgentRequestContractError, LlmOutputSchemaError
from agent.LLM.llm_service import LlmService
from agent.Prompts.prompt_loader import PromptLoader
from agent.api.contracts import AgentOperationRequest
from agent.Workflows.interview_models import WorkflowIntentDecision
...
class WorkflowRuntime:
    ...
    async def resolveWorkflow(self, request: AgentOperationRequest) -> WorkflowIntentDecision:
        ...
        messages = [
            {"role": "system", "content": self.promptLoader.loadPrompt("Interview/intent_router.txt")},
